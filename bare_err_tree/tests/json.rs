...
mod example {
    ...
    #[test]
    fn readme_example() {
        let expected_json = "{\"msg\":\"missed class\",\"location\":\"bare_err_tree/tests/../test_cases/json/src/bin/example.rs:51:6\",\"trace\":\"\\n│\\n├─ tracing frame 0 => json::example::gen_print_inner\\n│        at bare_err_tree/tests/../test_cases/json/src/bin/example.rs:38\",\"sources\":[{\"msg\":\"stayed in bed too long\",\"location\":\"bare_err_tree/tests/../test_cases/json/src/bin/example.rs:40:57\",\"trace\":\"\\n│\\n├─ tracing frame 1 => json::example::new with\\n│    bed_time=BedTime {\\n│      hour: 2,\\n│      reasons: [\\n│        FinishingProject(\\n│          ClassProject {\\n│            desc: \\\"proving 1 == 2\\\"\\n│          }\\n│        ),\\n│        ExamStressed,\\n│        PlayingGames\\n│      ]\\n│    }\\n│    _garbage=5\\n│        at bare_err_tree/tests/../test_cases/json/src/bin/example.rs:126\\n├─ 1 duplicate tracing frame(s): [0]\",\"sources\":[{\"msg\":\"bed is comfortable\",\"sources\":[]},{\"msg\":\"went to sleep at 2 A.M.\",\"location\":\"bare_err_tree/tests/../test_cases/json/src/bin/example.rs:41:9\",\"trace\":\"\\n│\\n├─ 1 duplicate tracing frame(s): [0]\",\"sources\":[{\"msg\":\"finishing a project\",\"sources\":[{\"msg\":\"proving 1 == 2\",\"sources\":[]}]},{\"msg\":\"stressed about exams\",\"sources\":[]},{\"msg\":\"playing video games\",\"sources\":[]}]}]}]}";
